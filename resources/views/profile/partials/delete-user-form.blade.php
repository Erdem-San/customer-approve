<section class="space-y-6">
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            {{ __('Zodra uw account is verwijderd, worden alle bronnen en gegevens permanent verwijderd. Download alle gegevens of informatie die u wilt behouden voordat u uw account verwijdert.') }}
        </p>
    </header>
