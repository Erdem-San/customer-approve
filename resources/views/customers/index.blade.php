                    ...
                    <div class="flex items-center justify-between space-x-2 mb-4">
                        <div class="flex items-center space-x-2">
                            <form id="importForm" action="{{ route('import.process') }}" method="POST" enctype="multipart/form-data" class="flex items-center">
                                ...
                                <button id="importButton" type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded flex space-x-2 items-center disabled:bg-gray-300 disabled:text-gray-400">
